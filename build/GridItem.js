...
var GridItem = /*#__PURE__*/function (_React$Component) {
  ...
  function GridItem() {
     ...
     */
    _defineProperty(_assertThisInitialized(_this), "onResizeStop", function (e, callbackData, position) {
      _this.onResizeHandler(e, callbackData, position, "onResizeStop");
    });
    /**
     ...
     * @param  {Object} callbackData  an object with node and size information
     */
    _defineProperty(_assertThisInitialized(_this), "onResizeStart", function (e, callbackData, position) {
      _this.onResizeHandler(e, callbackData, position, "onResizeStart");
    });
    /**
     ...
     * @param  {Object} callbackData  an object with node and size information
     */
    _defineProperty(_assertThisInitialized(_this), "onResize", function (e, callbackData, position) {
      _this.onResizeHandler(e, callbackData, position, "onResize");
    });
    return _this;
  }
  _createClass(GridItem, [{
    ...
    value: function mixinResizable(child /*: ReactElement<any>*/, position /*: Position*/, isResizable /*: boolean*/) /*: ReactElement<any>*/{
      ...
      var maxWidth = (0, _calculateUtils.calcGridItemPosition)(positionParams, 0, 0, cols, 0).width;
      ...
      , {
        ...
        onResizeStop: function onResizeStop(e, data, position) {
          return _this2.onResizeStop(e, data, _arguments[1]);
        },
        onResizeStart: function onResizeStart(e, data, position) {
          return _this2.onResizeStart(e, data, _arguments[1]);
        },
        onResize: function onResize(e, data, position) {
          return _this2.onResize(e, data, _arguments[1]);
        },
     ...
     */
    function onResizeHandler(e /*: Event*/, _ref4 /*:: */, position, handlerName /*: string*/) /*: void*/{
      var node = _ref4 /*:: */.node,
        size = _ref4 /*:: */.size,
        handle = _ref4 /*:: */.handle;
      ...
      // Get new XY
      var _calcWH = (0, _calculateUtils.calcWH)(this.getPositionParams(), size.width, size.height, x, y, handle),
        w = _calcWH.w,
        h = _calcWH.h;
