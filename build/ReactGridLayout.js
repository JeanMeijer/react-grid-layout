  ...
  function ReactGridLayout() {
    ...
    _defineProperty(_assertThisInitialized(_this), "onResize", function (i, w, h, _ref5) {
      ...
      if (["sw", "w", "nw", "n", "ne"].indexOf(handle) !== -1) {
        ...
        var isUserAction = true;
        finalLayout = (0, _utils.moveElement)(newLayout, l, _x2, _y, isUserAction, _this.props.preventCollision, (0, _utils.compactType)(_this.props), cols, allowOverlap);
      } else {
        l.w = w;
        l.h = h;
      ...
      _this.setState({
        layout: allowOverlap ? finalLayout : (0, _utils.compact)(finalLayout, (0, _utils.compactType)(_this.props), cols),
        activeDrag: placeholder
      });
    });
  ...
  _createClass(ReactGridLayout, [{
    ...
    function placeholder() /*: ?ReactElement<any>*/{
      ...
      return /*#__PURE__*/React.createElement(_GridItem.default, {
        ...
        y: activeDrag.y,
        i: activeDrag.i,
        className: (0, _clsx.default)("react-grid-placeholder", {
